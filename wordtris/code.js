      ...
      for (var t = 0; t < ID_array.length; t++)
        {
          ...
          {
            if((["11","12","13","14","15","16","17","18"].indexOf(ID_array[t]))>=0)
              {document.getElementById(ID_array[t]).innerHTML=alpha[Math.floor(Math.random()*alpha.length)]}
            else
